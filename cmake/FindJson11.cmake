...
set(JSON11_INCLUDE_DIRS ${CMAKE_BINARY_DIR}/lib/json11/include/${CMAKE_LIBRARY_ARCHITECTURE})

if(MSVC)
  set(JSON11_LIBRARIES ${CMAKE_BINARY_DIR}/lib/json11/lib/${CMAKE_STATIC_LIBRARY_PREFIX}json11${CMAKE_STATIC_LIBRARY_SUFFIX})
elseif(UNIX)
  set(JSON11_LIBRARIES ${CMAKE_BINARY_DIR}/lib/json11/lib/${CMAKE_LIBRARY_ARCHITECTURE}/${CMAKE_SHARED_LIBRARY_PREFIX}json11${CMAKE_SHARED_LIBRARY_SUFFIX})
endif()
