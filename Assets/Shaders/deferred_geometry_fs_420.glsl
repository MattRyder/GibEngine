...
void main() {
  ...
  g_Normal = normalize(texture(texture_normal1, VS.TexCoords).rgb);
  g_Albedo.rgb = texture(texture_diffuse1, VS.TexCoords).rgb;
  g_Albedo.a = texture(texture_specular1, VS.TexCoords).r;
}
